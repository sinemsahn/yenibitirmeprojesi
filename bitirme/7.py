...
#burada verileri iyi huylu ve kötü huylu olmak üzere tahmin etmesi için eğiteceğiz
#htmlleri sıkıştırıp tesk tip boyutlu veri olarak veriyor
...
if __name__ == '__main__':
    ...
    #diğer veriler az kalsın birer örnek hazırlayalım