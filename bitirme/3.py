...
if __name__ == '__main__':
    ...
    # bu dizini tarar ve pe olanları birleştirir
    ...
    # tüm pe olanalrı stirnglerini çıkarır ve noda yazar





    malware1 = args.malware_directory
    # kullanıcıdan alınan zararlı
